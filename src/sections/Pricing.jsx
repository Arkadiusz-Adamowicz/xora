              ...
              >
                ...
                >
                  ...
                  <div className="relative z-2 flex items-center justify-center">
                    ...
                    <div className="small-1 relative top-4 ml-1 self-start">
                      /mo
                    </div>
                  </div>
                </div>
                ...
                {index === 1 && (
                  <p className="small-compact after:content mt-9 text-center text-p3 before:mx-2.5 before:content-['-'] after:mx-2.5 after:content-['-']">
                    Limited time offer
                  </p>
                )}
              </div>
