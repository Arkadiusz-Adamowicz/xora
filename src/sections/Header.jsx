  ...
  return (
    <header className="fixed top-0 left-0 z-50 w-full py-10">
      <div className="container flex h-14 items-center max-lg:px-5">
        ...
        <div className="w-full max-lg:fixed max-lg:top-0 max-lg:left-0 max-lg:w-full max-lg max-lg:bg-s2 max-lg:opacity-0">
          <div
            className=" 
        ...
        >
          <img src={`/images/${isOpen ? "close" : "magic"}.svg`} alt="image" />
        </button>
      </div>
    </header>
  );
